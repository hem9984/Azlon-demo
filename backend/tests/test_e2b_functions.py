...
class TestE2BRunner:
    ...
    def e2b_mock(self):
        ...
        with patch("src.e2b_functions.Sandbox") as mock_sandbox_class:
            ...
            mock_sandbox_class.create.return_value = sandbox_instance
    ...
    @pytest.mark.asyncio
    async def test_init_sandbox(self, runner, e2b_mock):
        """Test initializing a sandbox."""
        # Mock configuration
        with patch("src.e2b_functions.os.getenv") as mock_getenv:
            mock_getenv.return_value = "test-api-key"

            # Call the function
            sandbox = await runner.init_sandbox()

            # Assertions
            assert sandbox is not None
            from src.e2b_functions import Sandbox

            Sandbox.create.assert_called_once()

    @pytest.mark.asyncio
    async def test_install_packages(self, runner, e2b_mock):
        """Test installing packages in the sandbox."""
        # Setup mock response for commands.run
        command_result = AsyncMock()
        command_result.exit_code = 0
        command_result.stdout = "Successfully installed packages"
        e2b_mock.commands.run.return_value = command_result

        # Call the function
        result = await runner.install_packages(e2b_mock, ["pytest", "requests"])
    ...
    @pytest.mark.asyncio
    async def test_install_packages_failure(self, runner, e2b_mock):
        ...
        # Call the function
        result = await runner.install_packages(e2b_mock, ["non-existent-package"])

        # Assertions
        assert result is False

    @pytest.mark.asyncio
    async def test_upload_file_to_e2b(self, runner, e2b_mock):
        """Test uploading a file to E2B."""
        # Setup file content and mock
        file_content = b"test content"

        # Call the function
        result = await runner.upload_file_to_e2b(e2b_mock, file_content, "/tmp/test.txt")
    ...
    @pytest.mark.asyncio
    async def test_upload_file_to_e2b_failure(self, runner, e2b_mock):
        """Test failure when uploading a file to E2B."""
        # Setup mock to raise an exception
        e2b_mock.files.write.side_effect = Exception("Upload failed")

        # Call the function
        result = await runner.upload_file_to_e2b(e2b_mock, b"content", "/tmp/test.txt")

        # Assertions
        assert result is False

    @pytest.mark.asyncio
    async def test_download_file_from_e2b(self, runner, e2b_mock):
        """Test downloading a file from E2B."""
        # Setup mock response
        e2b_mock.files.read.return_value = b"test content"

        # Call the function
        result = await runner.download_file_from_e2b(e2b_mock, "/tmp/test.txt")
    ...
    @pytest.mark.asyncio
    async def test_download_file_from_e2b_failure(self, runner, e2b_mock):
    ...
    @pytest.mark.asyncio
    async def test_run_command_in_e2b(self, runner, e2b_mock):
        ...
        # Call the function
        result = await runner.run_command_in_e2b(e2b_mock, "echo 'test'")
    ...
    @pytest.mark.asyncio
    async def test_file_exists_in_e2b(self, runner, e2b_mock):
        ...
        # Call the function
        result = await runner._file_exists_in_e2b(e2b_mock, "/tmp/test.txt")
    ...
    @pytest.mark.asyncio
    async def test_file_not_exists_in_e2b(self, runner, e2b_mock):
        ...
        # Call the function
        result = await runner._file_exists_in_e2b(e2b_mock, "/tmp/nonexistent.txt")
    ...
    @pytest.mark.asyncio
    async def test_generate_directory_tree(self, runner, e2b_mock):
        ...
        # Call the function
        result = await runner.generate_directory_tree(e2b_mock, "/tmp")
