...
class BamlStreamClient:
    ...
    def GenerateCode(
        ...
        input: types.GenerateCodeInput,systemprompt: Optional[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlStream[partial_types.GenerateCodeOutput, types.GenerateCodeOutput]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlStream[partial_types.GenerateCodeOutput, types.GenerateCodeOutput](
        raw,
