...
class BamlSyncClient:
    ...
    def GenerateCode(
        self,
        input: types.GenerateCodeInput,systemprompt: Optional[str],
        baml_options: BamlCallOptions = {},
    ) -> types.GenerateCodeOutput:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      raw = self.__runtime.call_function_sync(
        "GenerateCode",
        {
          "input": input,"systemprompt": systemprompt,
        },
        self.__ctx_manager.get(),
        tb,
        __cr__,
      )
      return cast(types.GenerateCodeOutput, raw.cast_to(types, types))
...
class BamlStreamClient:
    ...
    def GenerateCode(
        ...
        input: types.GenerateCodeInput,systemprompt: Optional[str],
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[partial_types.GenerateCodeOutput, types.GenerateCodeOutput]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb # type: ignore (we know how to use this private attribute)
      else:
      ...
      return baml_py.BamlSyncStream[partial_types.GenerateCodeOutput, types.GenerateCodeOutput](
        raw,
        lambda x: cast(partial_types.GenerateCodeOutput, x.cast_to(types, partial_types)),
        lambda x: cast(types.GenerateCodeOutput, x.cast_to(types, types)),
        self.__ctx_manager.get(),
      )
